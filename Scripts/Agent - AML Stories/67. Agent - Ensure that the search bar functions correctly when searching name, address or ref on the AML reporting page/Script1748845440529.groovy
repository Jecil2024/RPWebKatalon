...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML (1)/Reporting - AML bt'))
...
WebUI.verifyTextPresent('Jecil Lltest', false)

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML (1)/AML Reporting - Cancel (x) bt'))
...
WebUI.verifyTextPresent('Castle Jewellers, 66 Good Shepherd', false)
...
WebUI.verifyTextPresent('F7F40', false)
