...
'Search for name'
WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Search bar'), 
    'Katalon Aml Testing')

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Search icon'))

WebUI.verifyTextPresent('Katalon Aml Testing', false)

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Cancel (x) bt'))
...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Status - Pending'))

WebUI.switchToWindowIndex(1)

WebUI.verifyTextPresent('London Orthodontics', false)
