...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Owner is Business'))

WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Business name_textfield'), 
    'Katalon RP')

WebUI.selectOptionByLabel(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Business country of reg dropdown'), 
    'United Kingdom', false)

WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Landlord AML - Beneficial owner (individuals) name'), 
    'Jecil RP')
