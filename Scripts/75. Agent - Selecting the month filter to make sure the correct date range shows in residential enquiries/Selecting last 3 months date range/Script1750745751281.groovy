...
nextPageBtn.addProperty('xpath', com.kms.katalon.core.testobject.ConditionType.EQUALS, '//button[contains(text(),"Next")]')

// 1️⃣ --- Validate 3-month filter with pagination (scrolling included) ---
...
while (hasNextPage) {
    ...
    // 🔄 Check and scroll to Next button
