...
import invalidNumber.GenerateInvalidMobileNumber as GenerateInvalidMobileNumber
...
WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_09B7E renter mobile'), 
    '1234abcd')
...
WebUI.verifyTextPresent('Mobile format is invalid', false)

WebUI.delay(2)

WebUI.clearText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_09B7E renter mobile'))
...
WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_09B7E guarantor mobile'), 
    'abcd1234')
