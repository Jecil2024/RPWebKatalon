...
def initialFields = [
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - First Name field'), 'First name'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Last Name field'), 'Last name'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Address field'), 'Home address'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Email address field'), 'Email address'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Mobile number'), 'Mobile number']
]
...
def notUKFields = [
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - First Name field'), 'First name'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Last Name field'), 'Last name'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Home address line 1 field'), 'Home address line 1'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of kin - Home address line 2 (optional)'), 'Home address line 2 (optional)'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Town-City field'), 'Town/City'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Post code field'), 'Postcode'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Email address field'), 'Email address'],
    [findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Mobile number'), 'Mobile number']
]
...
def verifyPlaceholders(fieldsList) {
    boolean hasFailed = false
    fieldsList.each { fieldPair ->
        ...
        if (actualPlaceholder == null) actualPlaceholder = ''
