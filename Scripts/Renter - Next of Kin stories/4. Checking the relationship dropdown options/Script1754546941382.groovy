...
WebUI.click(findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Referencing - Next of Kin - Select relationship dropdown'))

WebUI.delay(2)

WebUI.verifyTextPresent('Spouse', false)

WebUI.verifyTextPresent('Son', false)

WebUI.verifyTextPresent('Daughter', false)

WebUI.verifyTextPresent('Father', false)

WebUI.verifyTextPresent('Mother', false)

WebUI.verifyTextPresent('Guarantor', false)

WebUI.verifyTextPresent('Roommate', false)

WebUI.verifyTextPresent('Friend', false)
