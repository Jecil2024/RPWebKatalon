...
WebUI.setText(findTestObject('Jecil/Agent/Properties-Onboarding - Search bar'), '41 Devonshire Road, BURNLEY, BB10 1AP')
...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/a_Tenancy'))
...
WebUI.verifyTextPresent('Onboarding: 41 Devonshire Road, BURNLEY, BB10 1AP', false)
