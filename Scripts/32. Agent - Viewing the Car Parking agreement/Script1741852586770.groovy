...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/In Tenancy Page - Car Parking - View Agreement bt'))
...
WebUI.verifyTextPresent('Dandara Living', false)

WebUI.verifyTextPresent('Management Limited', false)

WebUI.delay(2)

WebUI.verifyTextPresent('Licence agreement for', false)

WebUI.verifyTextPresent('renting a parking space', false)
