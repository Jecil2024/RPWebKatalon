...
WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Utilities - Search bar'), 
    'Shire House, Whinney Brow, Forton')

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Utilities - Search icon'))

WebUI.verifyTextPresent('Shire House, Whinney Brow, Forton', false)

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Utilities - Cancel (x) bt'))
...
WebUI.verifyTextPresent('Email Rtask', false)
