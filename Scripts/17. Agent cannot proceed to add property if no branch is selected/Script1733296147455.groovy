...
WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_Add property_searchbar'), 
    '3, 52A The Circus, BRISTOL, BS1 3BD, UNITED KINGDOM')

WebUI.sendKeys(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_Add property_searchbar'), 
