...
import customKeywords.RandomDataGenerator as RandomDataGenerator
...
String randomString = CustomKeywords.'customKeywords.RandomDataGenerator.generateRandomStringWithSpecialChars'(10)
...
WebUI.scrollToElement(findTestObject('Jecil/Agent/home_LOGOUT_bt'), 2)

WebUI.verifyTextPresent('Please enter a numeric rent amount', false)
