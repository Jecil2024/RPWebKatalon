...
TestObject fileInput = new TestObject('electricalCertInput')

fileInput.addProperty('id', ConditionType.EQUALS, 'electrical_certificate_doc')

// Wait until the file input is present
...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Electrical Certificate - Close (x) bt'))

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Electrical Certificate - Remove bt'))
