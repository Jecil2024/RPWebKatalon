...
TestObject fileInput = new TestObject('PATCertInput')

fileInput.addProperty('id', ConditionType.EQUALS, 'pat_doc')
...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/PAT Certificate - Close (x) bt'))

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/PAT Certificate - Remove bt'))
