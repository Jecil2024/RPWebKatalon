...
WebUI.setText(findTestObject('Jecil/Agent/Properties-Onboarding - Search bar'), 'FF8D2')
...
TestObject fileInput = new TestObject('gasSafetyCertInput')

fileInput.addProperty('id', ConditionType.EQUALS, 'gas_safety_doc')
...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Gas Safety Certificate - Close (x) bt'))

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Gas Safety Certificate - Remove bt'))
