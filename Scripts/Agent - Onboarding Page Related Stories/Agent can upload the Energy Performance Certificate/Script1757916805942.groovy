...
TestObject fileInput = new TestObject('energyCertInput')

fileInput.addProperty('id', ConditionType.EQUALS, 'energy_certificate_doc')
...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Energy Certificate - Close (x) bt'))

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Energy Certificate - Remove bt'))
