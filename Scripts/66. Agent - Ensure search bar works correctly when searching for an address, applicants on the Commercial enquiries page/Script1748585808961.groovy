...
WebUI.setText(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Commercial enquiries - Search bar'), 
    '2 Hollins')

WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Commercial enquiries - Search icon'))

WebUI.delay(2)

WebUI.verifyTextPresent('2 Hollins Hill', false)
...
WebUI.verifyTextPresent('Mae Gen', false)
