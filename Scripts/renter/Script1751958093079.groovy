...
def tabs = [
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Show All'), 'scope=show_all'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - My In Progress'), 'scope=my_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - My Team In Progress'), 'scope=my_team_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Landlord Checks In Progress'), 'scope=landlord_checks_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - All In Progress'), 'scope=all_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Unlinked'), 'scope=unlinked'],
    [findTestObject('Jecil/Admin/Page_Invites  RentProfile/Invites - Trial Pending'), 'scope=trials_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Clients In Progress'), 'scope=clients_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Testing In Progress'), 'scope=testing_in_progress'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Processed'), 'scope=processed'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Duplicates'), 'scope=duplicates'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Random Signups'), 'scope=random_signups'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Testing Processed'), 'scope=testing_processed'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Unresponsive Template'), 'scope=unresponsive_template'],
    [findTestObject('Jecil/Admin/Page_Renters  RentProfile/Renters - Permitted Occupier Processing'), 'scope=permitted_occupier_processing'],
...
for (def tab in tabs) {
    ...
    try {
        ...
        assert currentUrl.contains(urlFragment) : "URL does not match expected scope: ${urlFragment}"
