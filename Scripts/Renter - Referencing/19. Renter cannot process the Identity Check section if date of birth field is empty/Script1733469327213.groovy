...
WebUI.setText(findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_identity check address bar'), 
    '3')

WebUI.sendKeys(findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_identity check address bar'), 
...
WebUI.verifyTextPresent('Please enter your date of birth', false)
