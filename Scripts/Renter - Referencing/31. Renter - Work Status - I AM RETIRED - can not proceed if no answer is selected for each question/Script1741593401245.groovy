...
WebUI.click(findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Work status - I am retired bt'))

'Directly click \'Continue\' button no selected optins and should not proceed\r\n'
WebUI.click(findTestObject('Jecil/Renter/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Work status - Retired - Continue bt'))
