...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/input_Tenancy Renewal bt'))
...
WebUI.scrollToElement(findTestObject('Jecil/Agent/home_LOGOUT_bt'), 0)

WebUI.verifyTextPresent('Please confirm consent has been provided', false)
