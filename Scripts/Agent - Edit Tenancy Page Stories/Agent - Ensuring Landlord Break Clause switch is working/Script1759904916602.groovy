...
// ---------- XPATHS ----------
String xpathLBreakClauseSwitch = '//*[@id="landlordbreakclausedateswitch_switch"]'
String xpathLBreakClauseDropdown = '//*[@id="landlord_break_clause_term"]'
String xpathLBreakClauseDate = '//*[@id="landlord_break_clause_date"]'
String xpathProposedStartDate = '//*[@id="proposedmoveindate"]'
String xpathTenancyTerm = '//*[@id="tenancyterm"]'

// ---------- TEST OBJECTS ----------
TestObject switchObj = new TestObject().addProperty("xpath", ConditionType.EQUALS, xpathLBreakClauseSwitch)
TestObject dropdownObj = new TestObject().addProperty("xpath", ConditionType.EQUALS, xpathLBreakClauseDropdown)
TestObject breakDateObj = new TestObject().addProperty("xpath", ConditionType.EQUALS, xpathLBreakClauseDate)
...
boolean textPresent = WebUI.verifyTextPresent('The Landlord may terminate the tenancy', false, FailureHandling.OPTIONAL)
...
WebUI.switchToWindowIndex(0)
    ...
    TestObject breakClauseText = new TestObject('breakClauseText')
    breakClauseText.addProperty('xpath', ConditionType.EQUALS, "/html/body/div[3]/div[2]/div/table/tbody/tr[6]/td/table[1]/tbody/tr[4]/td/table/tbody/tr[13]/td[2]")
