...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Enquiries - View Tenancy bt'))

WebUI.delay(2)

WebUI.verifyTextPresent('In Tenancy: 2 The Clocktower, Brushford, DULVERTON, TA22 9AF', false)
