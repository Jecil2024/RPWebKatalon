...
WebUI.click(findTestObject('Jecil/Guarantor/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/span_guarantor TA details'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Jecil/Guarantor/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/p_guarantor Assured Shorthold'), 
    0)
