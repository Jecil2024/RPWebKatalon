...
WebUI.verifyTextPresent('Please enter the bay number', false)
...
WebUI.verifyTextPresent('Please enter the amount per month', false)
...
WebUI.verifyTextPresent('Please enter the direct debit reference', false)
