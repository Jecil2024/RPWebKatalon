...
WebUI.click(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Enquiries - PROGRESS APPLICATION TO ONBOARDING bt'))

WebUI.verifyTextPresent('2 The Clocktower, Brushford, DULVERTON, TA22 9AF', false)
