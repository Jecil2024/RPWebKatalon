...
WebUI.selectOptionByLabel(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Create Tenancy - Landlord (Dandara agent) dropdown'), 
    'Manchester - Botanica - PERL MANCHESTER GP LLP in its capacity as general partner of MANCHESTER OPCO LP', false)

WebUI.delay(2)

WebUI.verifyElementNotVisible(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Create Tenancy - Flatfair logo'))

WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('Jecil/Agent/Page_RentProfile  Onboarding eSign, Tenant Checks  Landlord AML/Create Tenancy - Landlord (Dandara agent) dropdown'), 
    'Liverpool - Baltic Yard - PERL LIVERPOOL GP LLP in its capacity as general partner of LIVERPOOL OPCO LP', false)
